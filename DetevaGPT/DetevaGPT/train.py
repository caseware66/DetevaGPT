...
class SupervisedTrainer:
        ...
        for epoch in trange(int(self.num_train_epochs), desc="Epoch"):
            ...
            for step, inputs in enumerate(
                ...
                with torch.set_grad_enabled(True):
                    ...
                    output = self.model(inputs['features'],inputs['text'],inputs['labels'])
    ...
    def _get_precision_recall_acc_macrof1(self, true_labels, pred_labels):
        ...
        f1_values = f1_score(true_labels, pred_labels, average=None)
        # 计算混淆矩阵
        ...
        print("Precision/Recall/F1/Accuracy per class: ")
        precision_recall = ' '.join(["{:.1f}/{:.1f}/{:.1f}/{:.1f}".format(p*100, r*100,f*100,a*100) for p, r,f,a in zip(precision, recall,f1_values,class_accuracies)])
        print(precision_recall)
        print("Accurancy/f1 per class: ")
