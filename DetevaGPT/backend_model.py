...
from backend_utils import BBPETokenizerPPLCalc, SPLlamaTokenizerPPLCalc, CharLevelTokenizerPPLCalc,QwenTokenizerFastPPLCalc, SPChatGLMTokenizerPPLCalc
...
class SnifferGPT2Model(SnifferBaseModel):
    ...
    def __init__(self):
        ...
        self.base_tokenizer = transformers.AutoTokenizer.from_pretrained(
            '/mnt/chenxi/project/SeqXGPT/SeqXGPT/model/gpt2-large')
...
class SnifferQwenModel(SnifferBaseModel):
    ...
    def __init__(self):
        ...
        self.do_generate = None
        self.text = None
        self.base_tokenizer= transformers.AutoTokenizer.from_pretrained('/mnt/chenxi/project/SeqXGPT/SeqXGPT/model/qwen')
        print(dir(self.base_tokenizer))
        self.base_model = AutoModelForCausalLM.from_pretrained('/mnt/chenxi/project/SeqXGPT/SeqXGPT/model/qwen')
        # self.base_tokenizer.pad_token_id = self.base_tokenizer.eos_token_id
        self.base_model.to(self.device)
        # byte_encoder = bytes_to_unicode()
        self.ppl_calculator = QwenTokenizerFastPPLCalc(
                                                   self.base_model,
                                                   self.base_tokenizer,
                                                   self.device)
...
class SnifferGPTNeoModel(SnifferBaseModel):
    ...
    def __init__(self):
        ...
        self.text = None
        self.base_tokenizer = transformers.AutoTokenizer.from_pretrained(
            '/mnt/chenxi/project/SeqXGPT/SeqXGPT/model/gpt-neo')
        self.base_model = transformers.AutoModelForCausalLM.from_pretrained(
            '/mnt/chenxi/project/SeqXGPT/SeqXGPT/model/gpt-neo', device_map="auto" )
        self.base_tokenizer.pad_token_id = self.base_tokenizer.eos_token_id
        byte_encoder = bytes_to_unicode()
        self.ppl_calculator = BBPETokenizerPPLCalc(byte_encoder,
                                                   self.base_model,
...
class SnifferGPTJModel(SnifferBaseModel):
    ...
    def __init__(self):
        ...
        self.text = None
        self.base_tokenizer = transformers.AutoTokenizer.from_pretrained(
            '/mnt/chenxi/project/SeqXGPT/SeqXGPT/model/gpt-j')
        self.base_tokenizer.pad_token_id = self.base_tokenizer.eos_token_id
        self.base_model = transformers.AutoModelForCausalLM.from_pretrained(
            '/mnt/chenxi/project/SeqXGPT/SeqXGPT/model/gpt-j', device_map="auto")
        byte_encoder = bytes_to_unicode()
        self.ppl_calculator = BBPETokenizerPPLCalc(byte_encoder,
                                                   self.base_model,
                                                   self.base_tokenizer,
